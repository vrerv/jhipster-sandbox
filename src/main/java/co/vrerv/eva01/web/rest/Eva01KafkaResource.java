...
@RestController
@RequestMapping("/api/eva-01-kafka")
public class Eva01KafkaResource {

    private final Logger log = LoggerFactory.getLogger(Eva01KafkaResource.class);
    ...
    public Eva01KafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
